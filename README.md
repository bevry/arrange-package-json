...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/arrange-package-json@^3.0.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/arrange-package-json@^3.0.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/arrange-package-json@3.0.0'
</script>
```
