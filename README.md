...
``` typescript
import pkg from 'https://unpkg.com/arrange-package-json@^4.6.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/arrange-package-json@^4.6.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/arrange-package-json@^4.6.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/arrange-package-json@4.6.0'
</script>
```
